export const enTranslations = {
    ...
    onboardingTitle: 'A smoother way to start every shift',
    onboardingSubtitle:
      'A quick walkthrough of the tools that keep employees informed, prepared, and ready to move.',
    onboardingSlideOneEyebrow: 'Discover',
    onboardingSlideOneTitle: 'See the work that fits your schedule',
    onboardingSlideOneBody:
      'Browse open roles, scan shift details, and understand where you need to be before you commit.',
    onboardingSlideOnePointOne: 'Clean job previews with location and timing context',
    onboardingSlideOnePointTwo: 'Fast access to shift expectations and support contacts',
    onboardingSlideOneMetricLabel: 'Open roles',
    onboardingSlideOneMetricValue: 'Live feed',
    onboardingSlideTwoEyebrow: 'Organize',
    onboardingSlideTwoTitle: 'Keep shifts, calendars, and updates in sync',
    onboardingSlideTwoBody:
      'Track assignments, monitor changes, and keep your month organized without hunting through messages.',
    onboardingSlideTwoPointOne: 'Calendar visibility across current and upcoming work',
    onboardingSlideTwoPointTwo: 'Status-aware updates so important changes stand out',
    onboardingSlideTwoMetricLabel: 'Schedule',
    onboardingSlideTwoMetricValue: 'Always current',
    onboardingSlideThreeEyebrow: 'Clock in',
    onboardingSlideThreeTitle: 'Scan in quickly when you arrive',
    onboardingSlideThreeBody:
      'Use QR clock-in to confirm arrival faster and reduce confusion at busy locations.',
    onboardingSlideThreePointOne: 'Simple QR flow designed for fast check-in moments',
    onboardingSlideThreePointTwo: 'Built for on-site clarity when timing matters',
    onboardingSlideThreeMetricLabel: 'Check-in',
    onboardingSlideThreeMetricValue: 'QR ready',
    onboardingSlideFourEyebrow: 'Stay informed',
    onboardingSlideFourTitle: 'Get the updates that matter most',
    onboardingSlideFourBody:
      'Notifications, account controls, and support details stay close so you can respond without friction.',
    onboardingSlideFourPointOne: 'Shift changes and reminders in one place',
    onboardingSlideFourPointTwo: 'Quick access to profile, support, and account tools',
    onboardingSlideFourMetricLabel: 'Visibility',
    onboardingSlideFourMetricValue: 'Real-time',
