export const deTranslations = {
    ...
    onboardingTitle: 'Ein ruhigerer Start in jede Schicht',
    onboardingSubtitle:
      'Ein kurzer Überblick über die Werkzeuge, die Mitarbeitende informiert, vorbereitet und einsatzbereit halten.',
    onboardingSlideOneEyebrow: 'Entdecken',
    onboardingSlideOneTitle: 'Sieh die Einsätze, die zu deinem Zeitplan passen',
    onboardingSlideOneBody:
      'Durchsuche offene Rollen, prüfe Schichtdetails und verstehe deinen Einsatzort, bevor du zusagst.',
    onboardingSlideOnePointOne: 'Klare Job-Vorschauen mit Ort und Zeitfenster',
    onboardingSlideOnePointTwo: 'Schneller Zugriff auf Erwartungen und Support-Kontakte',
    onboardingSlideOneMetricLabel: 'Offene Rollen',
    onboardingSlideOneMetricValue: 'Live-Feed',
    onboardingSlideTwoEyebrow: 'Organisieren',
    onboardingSlideTwoTitle: 'Halte Schichten, Kalender und Updates synchron',
    onboardingSlideTwoBody:
      'Behalte Einsätze im Blick, erkenne Änderungen früh und organisiere deinen Monat ohne Nachrichtenchaos.',
    onboardingSlideTwoPointOne: 'Kalender-Überblick über aktuelle und kommende Arbeit',
    onboardingSlideTwoPointTwo: 'Statusbasierte Updates, damit Wichtiges sofort auffällt',
    onboardingSlideTwoMetricLabel: 'Planung',
    onboardingSlideTwoMetricValue: 'Immer aktuell',
    onboardingSlideThreeEyebrow: 'Einchecken',
    onboardingSlideThreeTitle: 'Scanne dich schnell ein, sobald du ankommst',
    onboardingSlideThreeBody:
      'Nutze den QR-Check-in für eine schnellere Ankunftsbestätigung und weniger Verwirrung an belebten Einsatzorten.',
    onboardingSlideThreePointOne: 'Einfacher QR-Ablauf für schnelle Check-ins',
    onboardingSlideThreePointTwo: 'Für klare Abläufe vor Ort entwickelt, wenn Timing zählt',
    ...
    onboardingSlideFourTitle: 'Erhalte genau die Updates, die wirklich zählen',
    onboardingSlideFourBody:
      'Benachrichtigungen, Kontosteuerung und Support bleiben in Reichweite, damit du ohne Reibung reagieren kannst.',
    onboardingSlideFourPointOne: 'Schichtänderungen und Erinnerungen an einem Ort',
    onboardingSlideFourPointTwo: 'Schneller Zugriff auf Profil, Support und Konto-Tools',
    onboardingSlideFourMetricLabel: 'Überblick',
    onboardingSlideFourMetricValue: 'In Echtzeit',
