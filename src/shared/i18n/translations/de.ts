export const deTranslations = {
    ...
    biometricUnlockSetting: 'Biometrische Anmeldung',
    biometricStatusChecking: 'Verfügbarkeit wird geprüft...',
    biometricStatusUnavailable: 'Auf diesem Gerät nicht verfügbar',
    biometricStatusEnabled: 'Für dieses Konto aktiviert',
    biometricStatusDisabled: 'Deaktiviert',
    biometricEnablePrompt: 'Biometrische Anmeldung bestätigen',
    ...
    biometricUnlockBody: 'Mit Face ID oder Touch ID fortfahren.',
    biometricUnlockPrompt: 'Shiftor Employee entsperren',
    biometricUsePasscode: 'Code verwenden',
    biometricUnlocking: 'Wird geprüft...',
    biometricUnlockAction: 'Mit Biometrie entsperren',
