export const deTranslations = {
    ...
    onboardingSwipeHint: 'Wische zum Entdecken',
    onboardingHighlightsLabel: 'Das kannst du erledigen',
    onboardingTitle: 'Alles Wichtige, bevor deine Schicht beginnt',
    onboardingSubtitle:
      'Ein kurzer Überblick, wie Shiftor dir hilft, Einsätze zu finden, vorauszuplanen, einzuchecken und Änderungen im Blick zu behalten.',
    onboardingSlideOneEyebrow: 'Entdecken',
    onboardingSlideOneTitle: 'Finde schnell den passenden Einsatz',
    onboardingSlideOneBody:
      'Prüfe offene Rollen mit den wichtigsten Infos sofort, damit du schneller und sicherer entscheiden kannst.',
    onboardingSlideOnePointOne: 'Zeit, Ort und Rollen-Kontext auf einen Blick',
    onboardingSlideOnePointTwo: 'Sieh zuerst die Einsätze, die zu deiner Verfügbarkeit passen',
    onboardingSlideOnePointThree: 'Prüfe Erwartungen, bevor du dich für eine Schicht entscheidest',
    onboardingSlideOneSpotlightLabel: 'Besonders hilfreich für',
    onboardingSlideOneSpotlightValue: 'Schnelles Vergleichen von Einsätzen, wenn deine Woche noch flexibel ist.',
    onboardingSlideOneMetricLabel: 'Offene Rollen',
    onboardingSlideOneMetricValue: 'Live-Feed',
    onboardingSlideTwoEyebrow: 'Organisieren',
    onboardingSlideTwoTitle: 'Plane deine Woche ohne unnötiges Durcheinander',
    onboardingSlideTwoBody:
      'Behalte kommende Einsätze an einem Ort im Blick und erkenne sofort, was bestätigt, offen oder geändert ist.',
    onboardingSlideTwoPointOne: 'Aktuelle und kommende Arbeit in einer klareren Planung',
    onboardingSlideTwoPointTwo: 'Statusänderungen sehen, ohne Chatverläufe durchsuchen zu müssen',
    onboardingSlideTwoPointThree: 'Behalte einen verlässlichen Blick auf die nächsten Tage',
    onboardingSlideTwoSpotlightLabel: 'Besonders hilfreich für',
    onboardingSlideTwoSpotlightValue: 'Den Überblick, wenn mehrere Einsätze oder Änderungen gleichzeitig eintreffen.',
    onboardingSlideTwoMetricLabel: 'Planung',
    onboardingSlideTwoMetricValue: 'Immer aktuell',
    onboardingSlideThreeEyebrow: 'Einchecken',
    onboardingSlideThreeTitle: 'Checke schnell ein, sobald du ankommst',
    onboardingSlideThreeBody:
      'Nutze den QR-Check-in für einen schnellen Start vor Ort, besonders wenn viele Ankünfte gleichzeitig laufen.',
    onboardingSlideThreePointOne: 'Ein fokussierter Ablauf für schnelle Ankunftsbestätigung',
    onboardingSlideThreePointTwo: 'Weniger Verwirrung am Eingang, mehr Sicherheit im Einsatz',
    onboardingSlideThreePointThree: 'Starte die Schicht mit einer klareren Erfassung deiner Ankunft',
    onboardingSlideThreeSpotlightLabel: 'Besonders hilfreich für',
    onboardingSlideThreeSpotlightValue: 'Belebte Einsatzorte, an denen ein schneller und verlässlicher Check-in zählt.',
    ...
    onboardingSlideFourTitle: 'Bleib abgestimmt, sobald die Schicht steht',
    onboardingSlideFourBody:
      'Halte Erinnerungen, Profileinstellungen und Kontoaktionen griffbereit, damit du ohne Reibung reagieren kannst.',
    onboardingSlideFourPointOne: 'Erinnerungen und wichtige Schichtänderungen an einem Ort',
    onboardingSlideFourPointTwo: 'Profil aktualisieren und Onboarding jederzeit erneut ansehen',
    onboardingSlideFourPointThree: 'Wichtige Kontoaktionen griffbereit halten, wenn sich Pläne ändern',
    onboardingSlideFourSpotlightLabel: 'Besonders hilfreich für',
    onboardingSlideFourSpotlightValue: 'Späte Änderungen, ohne dabei die wichtigsten Schritte aus dem Blick zu verlieren.',
