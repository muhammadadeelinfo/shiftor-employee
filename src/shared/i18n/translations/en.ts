export const enTranslations = {
    ...
    onboardingSwipeHint: 'Swipe to explore',
    onboardingHighlightsLabel: 'What you can do',
    onboardingTitle: 'Everything you need, before the shift starts',
    onboardingSubtitle:
      'A short walkthrough of how Shiftor helps you find work, plan ahead, clock in, and stay on top of changes.',
    onboardingSlideOneEyebrow: 'Discover',
    onboardingSlideOneTitle: 'Find the right job quickly',
    onboardingSlideOneBody:
      'Review open roles with the key details up front, so you can decide faster and with more confidence.',
    onboardingSlideOnePointOne: 'See timing, location, and role context at a glance',
    onboardingSlideOnePointTwo: 'Open the shifts that match your availability first',
    onboardingSlideOnePointThree: 'Review expectations before you commit to the shift',
    onboardingSlideOneSpotlightLabel: 'Best for',
    onboardingSlideOneSpotlightValue: 'Comparing opportunities quickly when your week is still flexible.',
    onboardingSlideOneMetricLabel: 'Open roles',
    onboardingSlideOneMetricValue: 'Live feed',
    onboardingSlideTwoEyebrow: 'Organize',
    onboardingSlideTwoTitle: 'Plan your week without the clutter',
    onboardingSlideTwoBody:
      'Keep upcoming assignments clear in one place and understand what is confirmed, pending, or changing.',
    onboardingSlideTwoPointOne: 'View current and upcoming work in a cleaner schedule flow',
    onboardingSlideTwoPointTwo: 'Spot status changes without digging through chat threads',
    onboardingSlideTwoPointThree: 'Keep one reliable view of what your next days look like',
    onboardingSlideTwoSpotlightLabel: 'Best for',
    onboardingSlideTwoSpotlightValue: 'Staying organized when several assignments or updates land at once.',
    onboardingSlideTwoMetricLabel: 'Schedule',
    onboardingSlideTwoMetricValue: 'Always current',
    onboardingSlideThreeEyebrow: 'Clock in',
    onboardingSlideThreeTitle: 'Check in fast when you arrive',
    onboardingSlideThreeBody:
      'Use QR clock-in for a quick start on site, especially when arrivals are busy and time matters.',
    onboardingSlideThreePointOne: 'A focused flow built for fast arrival confirmation',
    onboardingSlideThreePointTwo: 'Less confusion at the door, more confidence on the floor',
    onboardingSlideThreePointThree: 'Start the shift with a clearer record of your arrival',
    onboardingSlideThreeSpotlightLabel: 'Best for',
    onboardingSlideThreeSpotlightValue: 'Busy locations where teams need a fast, reliable check-in routine.',
    onboardingSlideThreeMetricLabel: 'Check-in',
    onboardingSlideThreeMetricValue: 'QR ready',
    onboardingSlideFourEyebrow: 'Stay informed',
    onboardingSlideFourTitle: 'Stay aligned after the shift is assigned',
    onboardingSlideFourBody:
      'Keep reminders, profile settings, and account actions close so you can respond without losing momentum.',
    onboardingSlideFourPointOne: 'Follow reminders and important shift changes in one place',
    onboardingSlideFourPointTwo: 'Update your profile and revisit onboarding anytime',
    onboardingSlideFourPointThree: 'Keep important account tools close when plans change',
    onboardingSlideFourSpotlightLabel: 'Best for',
    onboardingSlideFourSpotlightValue: 'Handling last-minute adjustments without losing track of the essentials.',
