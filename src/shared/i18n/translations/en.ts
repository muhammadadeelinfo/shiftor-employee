export const enTranslations = {
    ...
    shiftPlanExportAction: 'Export schedule',
    shiftPlanExportTitle: 'Shift plan export',
    shiftPlanExportSuccessBody: 'Saved under {path}.',
    shiftPlanExportEmptyBody: 'There are no shifts available to export yet.',
    shiftPlanExportFailedBody: 'We could not export your shift plan right now. Please try again.',
