export const enTranslations = {
    ...
    guestAboutBody:
      'Browse open jobs, explore the public calendar, and learn how Shiftor works before you sign in.',
    guestAboutPreviewTitle: 'What you can do before sign in',
    ...
    guestAboutPreviewUnlock: 'Sign in to unlock personal shifts, clock in/out, and company-specific actions.',
    ...
    loginSignInSubtitle: 'Sign in or create your account.',
    ...
    signupSubtitle: 'Sign in or create your account.',
    ...
    calendarGuestBody:
      'Use this planner freely to browse the public month view, scan each day, and follow availability without signing in.',
    ...
    qrClockInSignInRequired: 'Sign in to use QR clock-in/out.',
